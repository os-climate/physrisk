...
\subsection{Hazard models}
Water stress is modelled as a chronic risk using some indicators of water-related risks implemented by the World Resources Institute (WRI) Aqueduct 4.0 \cite{KuzmaEtAl:2023}:
\begin{itemize}
