...
dest_prefix="hazard" #_test" # prefix for zarr storage within bucket; use 'hazard_test' for testing, 'hazard' for final version 
...
src_dir="/Users/joemoorhouse/Code/data/heat/hdd32cdataset"
...
# onboard_chronic_heat(src_dir, dest_bucket=dest_bucket, dest_prefix=dest_prefix, s3_dest=s3) # create zarr from file as one-off
create_map_geotiffs_chronic_heat(dest_bucket=dest_bucket, dest_prefix=dest_prefix, map_working_dir=map_working_dir, account="osc", dest_s3=s3) # create map geotiffs from zarr
