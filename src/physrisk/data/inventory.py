        ...
        wri_riverine_inundation_models = [
            {
                ...
                "map": { "colormap": "flare_intensity_0_2", "filename": "inunriver_{scenario}_{id}_{year}_rp{return_period:05d}" },
                "units": "metres",
                "scenarios": [
                    { 
                        "id": "historical",
            ...
            },
            {
                ...
                "description": "World Resources Institute Aqueduct flood model with GCM model: Bjerknes Centre for Climate Research, Norwegian Meteorological Institute",
                "filename": "inunriver_{scenario}_{id}_{year}",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inunriver_{scenario}_{id}_{year}_rp{return_period:05d}" },
                "units": "metres",
                "scenarios": [
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with GCM model: Geophysical Fluid Dynamics Laboratory (NOAA)",
                "filename": "inunriver_{scenario}_{id}_{year}",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inunriver_{scenario}_{id}_{year}_rp{return_period:05d}" },
                "units": "metres",
                "scenarios": [
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with GCM model: Institut Pierre Simon Laplace",
                "filename": "inunriver_{scenario}_{id}_{year}",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inunriver_{scenario}_{id}_{year}_rp{return_period:05d}" },
                "units": "metres",
                "scenarios": [
        ...
        wri_coastal_inundation_models = [
            {
                ...
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_historical_nosub_hist_rp{return_period:04d}_0" },
                "units": "metres",
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with no subsidence; 95th percentile sea level rise",
                "filename": "inuncoast_{scenario}_nosub_{year}_0",
                "map": { "colormap": "flare_intensity_0_2", "filename":  "inuncoast_{scenario}_nosub_{year}_rp{return_period:04d}_0" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with no subsidence; 5th percentile sea level rise",
                "filename": "inuncoast_{scenario}_nosub_{year}_0_perc_05",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_{scenario}_nosub_{year}_rp{return_period:04d}_0_perc_05" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with no subsidence; 50th percentile sea level rise",
                "filename": "inuncoast_{scenario}_nosub_{year}_0_perc_50",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_{scenario}_nosub_{year}_rp{return_period:04d}_0_perc_50" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with baseline condition; with subsidence",
                "filename": "inuncoast_historical_wtsub_hist_0",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_historical_wtsub_hist_rp{return_period:04d}_0" },
                "units": "metres",
                "scenarios": [{"id": "historical", "years": [1980]}],
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with subsidence; 95th percentile sea level rise",
                "filename": "inuncoast_{scenario}_wtsub_{year}_0",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_{scenario}_wtsub_{year}_rp{return_period:04d}_0" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with with subsidence; 5th percentile sea level rise",
                "filename": "inuncoast_{scenario}_wtsub_{year}_0_perc_05",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_{scenario}_wtsub_{year}_rp{return_period:04d}_0_perc_05" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
            ...
            },
            {
                ...
                "description": "World Resource Institute Aqueduct flood model with subsidence; 50th percentile sea level rise",
                "filename": "inuncoast_{scenario}_wtsub_{year}_0_perc_50",
                "map": { "colormap": "flare_intensity_0_2", "filename": "inuncoast_{scenario}_wtsub_{year}_rp{return_period:04d}_0_perc_50" },
                "units": "metres",
                "scenarios": [
                    {"id": "rcp4p5", "years": [2030, 2050, 2080]},
                    {"id": "rcp8p5", "years": [2030, 2050, 2080]},
        ...
        for model in models:
            ...
            for scenario in model.scenarios:
                ...
                for year in scenario.years:
                    name_format = model.filename if model.map is None or model.map.filename is None else model.map.filename 
                ...
                if test_periods is not None:
                    for (period, test_period) in zip(scenario.periods, test_periods):
                        if period.map_id != test_period.map_id:
                            raise Exception(f"validation error: hash {period.map_id} different to specified hash {test_period.map_id}")
