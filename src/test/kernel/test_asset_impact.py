...
class TestAssetImpact(unittest.TestCase):
    ...
    def test_impact_curve(self):
        ...
        depths = np.array([0.059601218, 0.33267087, 0.50511575, 0.71471703, 0.8641244, 1.0032823, 1.1491022, 1.1634114, 1.1634114])
        ...
        # we could also choose ensure that all impact curve depth points are represented in exceedance curve; we do not here
