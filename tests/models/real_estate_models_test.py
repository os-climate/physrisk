...
from physrisk.kernel import calculation  # noqa: F401 ## Avoid circular importsfrom physrisk.kernel.impact import ImpactKey, calculate_impacts
...
def test_real_estate_model_details():
...
def test_coastal_real_estate_model():
...
def test_commercial_real_estate_model_details():
    curve = np.array(
        [
            2.8302893e-06,
            0.09990284,
